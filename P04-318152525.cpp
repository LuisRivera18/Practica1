	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Animal
		{
			...
			////AQUÍ SE DIBUJA LA CABINA, LA BASE, LAS 4 LLANTAS
			//BASE PRINCIPAL
			model = glm::translate(model, glm::vec3(-17.0f, 5.0f, -4.0f));
			model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));

			color = glm::vec3(0.694118f, 0.470588f, 0.329412f);
			modelaux = model;

			model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
			model = glm::scale(model, glm::vec3(1.0f, 6.0f, 2.0f));
			glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
			glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
			glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
			glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
			...
			//cabeza
			{
				...
				model = modelaux2;
				model = glm::translate(model, glm::vec3(-0.4f, -0.9f, 0.0f));
				modelaux2 = model;
				...
				model = modelaux2;
				model = glm::translate(model, glm::vec3(-0.6f, 1.0f, -0.3f));
				...
				//orejas
				model = modelaux2;
				model = glm::translate(model, glm::vec3(0.3f, 2.5f, -0.4f));
